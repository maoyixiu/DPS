...
class TaskRunner:
    def run(self, config):
        ...
        if 'deepscaler' in config.data.train_files:
            config.custom_reward_function['path'] = './recipe/dps/reward_func/deepscaler_reward.py'
            config.custom_reward_function['name'] = 'deepscaler_reward_fn'
        elif 'countdown' in config.data.train_files:
            config.custom_reward_function['path'] = './recipe/dps/reward_func/countdown_reward.py'
            config.custom_reward_function['name'] = 'compute_score'
        elif 'math' in config.data.train_files:
            config.custom_reward_function['path'] = './recipe/dps/reward_func/math_reward.py'
            config.custom_reward_function['name'] = 'compute_score'
        elif 'geo3k' in config.data.train_files:
            config.custom_reward_function['path'] = './recipe/dps/reward_func/geo3k_reward.py'
            config.custom_reward_function['name'] = 'compute_score'
