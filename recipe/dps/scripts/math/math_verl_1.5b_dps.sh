...
project_name='math'
exp_name='verl-1.5b-math-dps-topk-decay'
...
python3 -m recipe.dps.main_our \
    ...
    trainer.total_training_steps=360 \
    trainer.default_local_dir="${CKPTS_DIR}" \
    trainer.resume_mode=disable \
    tasksampler.candidate_ratio=32 \
    tasksampler.framework=1 \
    tasksampler.hmm_sample_strategy="topk"\
    tasksampler.hmm_prior_alpha=1.0\
    tasksampler.hmm_transition_decay_ratio=0.7\
    "${@:1}"
